...
- **Muerto REAL sin variante (reemplazo editorial pendiente):** perfume Asad Negro MLAU3562485598 (3 guías árabes). Correr `node scripts/stock-watchdog.cjs` para el estado actual.
