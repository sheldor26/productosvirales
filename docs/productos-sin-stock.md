...
| Parrilla Eléctrica Novohome NH-GR1000 (clamshell) | MLA56253561 | 2026-09-08 | "Publicación pausada" en ML, no se puede comprar — confirmado por Juan al chequearla en vivo (el scraper local (`npm run prices:check`) también dio `ML_SECURITY_VERIFICATION`, sin poder confirmar por su cuenta). Ficha completa (specs, pros/cons, articleBody) escrita el 20-jul como 4to producto de la guía `parrilla-electrica`, pero sacada de esa guía al publicarla el 10-ago por estar pausada entonces — quedó huérfana en `curated-products.ts` sin marcar. | `parrilla-electrica`: nunca llegó a estar en la guía publicada, sin impacto en contenido publicado. Se sacó del `relatedProducts` y de la frase comparativa "Frente a la Novohome..." de las 3 fichas hermanas que sí están en la guía (Black+Decker Sizzlelean MLA14097409, Atma PG4720E MLA26041341, Philco PGE389BP MLA41223080), porque esas frases decían "de esta guía" sobre un producto que no está en ella y linkeaban a una ficha no comprable. | 2026-09-08 (recién marcado) |
