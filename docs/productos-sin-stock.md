...
| Anillo Inteligente Oura Ring 4 Titanio Negro Talle 9 | MLA66785049 | 2026-09-04 | "Este producto no está disponible. Elige otra variante." en ML, sin ninguna variante alternativa a la que cambiar. Reproducible tras recargar. Las demás publicaciones de "Oura Ring 4" que aparecen en el buscador son todas de importación internacional (USA), no stock doméstico. Verificado en vivo. | Ya estaba mencionada en la guía `smartwatch` (sección "Anillo inteligente") y era una de los tres productos comparados en la ficha del Ignix K3 y del Amazfit Helio Ring: se actualizaron las tres menciones para reflejar la falta de stock, se sacaron los links directos a su ficha desde esas dos fichas hermanas (quedó mencionada por nombre, sin link), y se creó la guía nueva `anillo-inteligente` con los 2 productos que sí tienen stock (Ignix K3, Amazfit Helio Ring), con un callout explícito explicando la baja del Oura. | 2026-09-04 (recién marcado) |
| Parrilla Eléctrica Novohome NH-GR1000 Clamshell | MLA56253561 | 2026-09-15 | "Este producto no está disponible. Elige otra variante." en ML. Verificado en vivo. Detectado originalmente el 2026-09-08 en una sesión que dejó el fix sin mergear (rama huérfana sin PR); revalidado en vivo antes de aplicarlo, seguía sin stock una semana después. | `parrillas-electricas` (guía de comparativa): sacada de `relatedProducts` de las 3 fichas hermanas (Atma PG4720E, Black+Decker Sizzlelean, Philco PGE389BP) y de sus 3 párrafos "Cómo se compara con las otras de esta guía". Ficha propia marcada `visibility: deprioritized`, `priceStatus: out_of_stock`. | 2026-09-15 (recién marcado) |
| Ventilador De Techo Kent K3001 Industrial | MLA57107638 | 2026-09-21 | Publicación pausada/dada de baja: al abrir la ficha ML muestra solo "También puede interesarte" + una grilla de "Productos relacionados", sin buy box ni precio. Verificado en vivo (Chrome logueado), reproducible tras cerrar y reabrir la pestaña. | `ventilador-de-techo` (guía pilar, silo climatizacion): **reemplazado** en las 6 menciones (quickPicks, callout "Respuesta rápida", H3 dedicado + product-card, tabla comparativa, lista de precios, veredicto) por el Ventilador De Techo Protalia Industrial 3 Palas Blanco 1.2m (MLA57722520, ficha nueva, mismo rol "para quincho o galpón, el más barato de la guía"). Ficha del Kent marcada `visibility: deprioritized`, `priceStatus: out_of_stock`, se conserva íntegra como registro. | 2026-09-21 (recién marcado) |
