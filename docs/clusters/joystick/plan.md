...
### Guía — Joystick Xbox
Anclas reales (verificadas en ML AR, 2026-07-02): **Xbox Wireless oficial** (negro, MLA12384031, **468 reseñas**, ~$120.000) = el estándar de PC y consola (XInput, plug-and-play, funciona en Xbox Series/One, PC, celular); **Xbox Elite Series 2** (MLA19627127, 69 reseñas, ~$330.000) = premium con paletas y gatillos ajustables. NO usar el catálogo de Xbox 360 (MLA23140885): está fuera del programa de afiliados y es viejo.
Ejes: conexión (Bluetooth vs receptor), pilas AA vs recargable (el oficial usa pilas AA; el kit recargable se compra aparte). Contra honesta: hay menos opciones third-party confiables que en PC genérico, y Xbox es minoría en AR (el oficial tiene 468 reseñas, decente pero lejos de las 18.414 del DualSense). Cuña AR: precios reales de ML + que el control de Xbox sirve igual para PC (su gran valor, doble uso).
